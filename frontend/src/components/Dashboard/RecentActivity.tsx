  ...
  return (
    <>
      <Card className="relative overflow-hidden border-0 shadow-xl hover:shadow-2xl transition-all duration-300 bg-gradient-to-br from-white via-slate-50/20 to-blue-50/30 dark:from-slate-900 dark:via-slate-800/50 dark:to-blue-950/20 group">
        ...
        <CardHeader className="bg-gradient-to-r from-slate-50/50 to-blue-50/50 dark:from-slate-950/30 dark:to-blue-950/30 border-b border-slate-200 dark:border-slate-700 backdrop-blur-sm relative">
          <CardTitle className="flex items-center gap-2 text-base md:text-lg font-black bg-gradient-to-r from-slate-700 to-blue-600 dark:from-slate-300 dark:to-blue-400 bg-clip-text text-transparent">
